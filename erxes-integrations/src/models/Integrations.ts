...
import { fieldEncryptionPlugin } from './encryption';
...
// Применяем шифрование к чувствительным полям
integrationSchema.plugin(fieldEncryptionPlugin, {
  fields: ['nylasToken', 'telegramBotToken', 'viberBotToken', 'lineChannelSecret', 'twilioAuthToken', 'whatsappToken']
});
